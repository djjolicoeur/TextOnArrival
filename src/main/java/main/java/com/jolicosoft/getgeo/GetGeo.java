...
public class GetGeo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button locationMapButton = (Button) findViewById(R.id.maplocationbutton);// new

        locationMapButton.setText("Choose From Map");
        locationMapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent getLocationFromMap = new Intent(GetGeo.this, GetLocationFromMap.class);
                getLocationFromMap.putExtra("pNum", phoneNumber.getText().toString()
                        .trim());
                startActivity(getLocationFromMap);
                GetGeo.this.finish();
            }
        });
